...
public interface EnrollmentMapper {
    ...
    @Mapping(source = "course.isActive", target = "courseActive")
    ...
    @Mapping(source = "enrollment.active", target = "isActive")
    @Mapping(source = "enrollment.course.isActive", target = "courseActive")
